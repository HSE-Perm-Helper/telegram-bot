...
async def get_settings(message: Message, state: FSMContext):
    ...
    keyboard.row(InlineKeyboardButton(text="⚡️Перейти в бота", url="https://t.me/okvpn_xbot?start=ref__ec6e9bd3-54b2-4ee3-9965-6263c4fd981b"))

    await message.answer("<b>OKVPN</b> – быстрый и недорогой VPN на базе телеграмм бота, созданный студентами Вышки ✨🧑‍💻\n\n" +
